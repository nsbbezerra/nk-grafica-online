          ...
          {products?.map((prod) => (
            <div className="card" key={prod.id}>
              {prod.shippingOptions === "fast" && (
                <div className="flex items-center gap-2 bg-sky-100 text-sm rounded-md py-1 px-2 text-primary-500 font-semibold w-fit absolute z-[5] dark:bg-zinc-600 dark:text-white right-3 top-3 shadow">
